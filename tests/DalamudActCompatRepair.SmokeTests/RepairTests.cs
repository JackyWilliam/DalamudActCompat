    ...
    internal static class Tests
    {
        ...
        private static int Main(string[] args)
        {
            try
            {
                ...
                ExpectFailure(() => Run(racing, () => ++calls == 3 ? "DACT" : null), "race");
                ...
                if (args.Length > 1 && args[1] != "-") NativePreview.Save(args[1]);
        ...
        private static string Create(string name, bool existingTarget)
        {
            ...
            File.WriteAllText(Path.Combine(Old(dir), RepairEngine.PluginName + ".json"), JsonConvert.SerializeObject(manifest));
        ...
        private static void Success()
        {
            ...
            var fresh = JsonConvert.DeserializeObject<Dictionary<string, object>>(File.ReadAllText(Path.Combine(Target(dir), RepairEngine.PluginName + ".json")));
