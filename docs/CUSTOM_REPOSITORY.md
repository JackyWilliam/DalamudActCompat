...
2. Publish `DalamudActCompat.zip` to `https://github.com/raynording/DalamudActCompat/releases`.
...
1. Create a public repository named `raynording/DalamudActCompatRepo`.
2. Add a repository secret named `DALAMUD_REPO_TOKEN` to the source repository. The token needs write access to `raynording/DalamudActCompatRepo`.
...
5. Verify `https://raw.githubusercontent.com/raynording/DalamudActCompatRepo/main/pluginmaster.json`.
