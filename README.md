...
- `0.1.12` targets Dalamud API Level 15, decodes Chinese-region combat packets for the in-game meter, and packages the complete self-hosted runtime in one ZIP.
