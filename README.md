...
- `0.1.10` targets Dalamud API Level 15 and packages the parser, OverlayPlugin, compatibility assembly, executable parser modules, and runtime dependencies in one ZIP.
