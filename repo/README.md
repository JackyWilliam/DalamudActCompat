...
This directory contains the `pluginmaster.json` file that should be copied or mirrored into the public distribution repository `raynording/DalamudActCompatRepo`.
